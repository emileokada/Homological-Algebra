...
\end{proposition}
\begin{proof}
    Let $\shf I = \ker f^\#$ and $\shf I_Y$ be the maximal quasi-coherent sheaf of ideals contained in $\shf I$ (take the sum).
    Let $i:Z\to X$ be the corresponding closed embedding.
\end{proof}
